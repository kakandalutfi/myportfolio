...
const products = [
  {
    ...
    tags: ["Landing Page", "saas", "Next.js", "typescript", "Tailwind Css", "Dark Mode", "White Mode", "Responsive"],
  ...
  },
  {
    ...
    tags: ["Landing Page", "Saas", "React.js", "Tailwind Css", "Dark Mode", "White Mode", "Modern", "Responsive"],
  ...
  },
  {
    ...
    tags: ["Landing Page", "Next.Js", "typescript", "Tailwind Css", "Modern", "Responsive"],
